...
public class CommonConstants{
    ...
    //taskpanel config
    public static final Dimension TASKPANEL_SIZE =  new Dimension(GUI_SIZE.width - 10,GUI_SIZE.height-170);

    //addtask button config
    ...
    public static final Dimension DELETE_BUTTON = new Dimension((int)(TASKFIELD_SIZE.width * 0.12), 50 );
}